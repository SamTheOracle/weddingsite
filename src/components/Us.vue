    ...
    return {
      ...
      imageText: [
        ...
        },
        {
          ...
          description:
            "La strada è da fare è ancora lunga, ma la natura circostante ci solleva d'animo!"
        },
        {
      ...
      imageTextEnglish: [
        ...
        },
        {
          ...
          subtitle: "Isola d'Arbia, Siena",
          description:
            "The road after us is still long, but the nature sorrounding us cheers us up!"
        },
        {
